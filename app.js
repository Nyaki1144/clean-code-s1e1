...
var addButton = document.querySelectorAll(".main-btn")[0];//first button
...
var createNewTaskElement = function (taskString) {
  ...
  editButton.className = "main-btn";

  deleteButton.className = "main-btn delete-btn";
...
var editTask = function () {
  ...
  var label = listItem.querySelector(".section-task");
  var editBtn = listItem.querySelector(".main-btn");
  var containsClass = listItem.classList.contains("section-content__edit");
  ...
  listItem.classList.toggle("section-content__edit");
};
...
var bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  var editButton = taskListItem.querySelector(".main-btn");
